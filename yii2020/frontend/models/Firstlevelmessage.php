 ...
 * This is Firstlevelmessage model of the frontend MessageBox part
 */
 ...
 */
class Firstlevelmessage extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
    	return Seclevelmessage::find()->where(['flmID'=>$this->flmID])->count();
    }

    public function getHlwseclevelmessages()
    {
        return $this->hasMany(seclevelmessage::className(), ['flmID' => 'flmID']);
    }
    ...
    {
        return $model=firstlevelmessage::find()->orderBy('secNum DESC')->limit($limit)->all();
    }
}
