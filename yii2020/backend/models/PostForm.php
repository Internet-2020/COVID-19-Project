...
class PostForm extends Model
{
	...
	{
		$scenarios = [
			self::SCENARIOS_CREATE => ['title', 'media', 'content', 'label_img', 'cat_id', 'tags', 'summary'],
			self::SCENARIOS_UPDATE => ['title', 'media', 'content', 'label_img', 'cat_id', 'tags', 'summary'],
		];
	...
	{
		return[
			[['id','title','content','cat_id','summary'],'required'],
			[['id','cat_id'],'integer'],
